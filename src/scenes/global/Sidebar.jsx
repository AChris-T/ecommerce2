     ...
     <ProSidebar collapsed={isCollapsed}>
        ...
        {!isCollapsed && (
          <Box mb="25px">
            ...
            <img 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-ZCjhepvXEgHUlxP_thYiqXXW_n3YyRPa-g&usqp=CAU" alt="profile-img"
            width="100px"
            height='100px' 
            style={{cursor:"pointer", borderRadius:"50%"}}/>
            </Box>
          <Box textAlign="center">
              <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{m1:"10px 0 0 0"}}>Ed Roh </Typography>
